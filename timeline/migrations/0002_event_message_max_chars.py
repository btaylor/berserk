...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.message'
        db.alter_column('timeline_event', 'message', self.gf('django.db.models.fields.CharField')(max_length=512))


    def backwards(self, orm):
        
        # Changing field 'Event.message'
        db.alter_column('timeline_event', 'message', self.gf('django.db.models.fields.CharField')(max_length=256))
