...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Event.parent'
        db.add_column('timeline_event', 'parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['timeline.Event'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Event.parent'
        db.delete_column('timeline_event', 'parent_id')
    ...
    models = {
        ...
        'timeline.event': {
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['timeline.Event']", 'null': 'True', 'blank': 'True'}),
