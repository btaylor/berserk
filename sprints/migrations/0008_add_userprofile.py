...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.create_table('sprints_userprofile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True)),
            ('last_accessed_sprint', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['sprints.Sprint'], null=True, blank=True)),
        ))
        db.send_create_signal('sprints', ['UserProfile'])


    def backwards(self, orm):
        # Deleting model 'UserProfile'
        db.delete_table('sprints_userprofile')
    ...
    models = {
        ...
        'sprints.userprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_accessed_sprint': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['sprints.Sprint']", 'null': 'True', 'blank': 'True'}),
