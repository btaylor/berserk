...
// XXX: This is version includes changes to support AJAX-type updating of
// inner data of jquery-scroll at c30f3d4c70948bcf617b
...
(function($, document){
    ...
    $.fn.scrollbar.defaults = {
        ...
        pageFallbackScrolling: true    // when we cannot scroll anymore, should we pass scroll events back to the page?
    };
    ...
    $.fn.scrollbar.Scrollbar.prototype = {
        ...
        update: function(){
            ...
            this.props.contentHeight = this.pane.outerHeight();

            // if the content height is lower than the container height, hide the handle
            if(this.props.contentHeight <= this.props.containerHeight){
                this.handleContainer.hide();
                this.handle.hide();
                this.handleArrows.hide();
            } else {
                this.handleContainer.show();
                this.handle.show();
                this.handleArrows.show();
            }
        ...
        onMouseWheel: function(ev, delta){
            ...
            if(!this.opts.pageFallbackScrolling
               || (this.handle.top > this.props.handleTop.min
                   && this.handle.top < this.props.handleTop.max)){
                ev.preventDefault();
            }
        },
